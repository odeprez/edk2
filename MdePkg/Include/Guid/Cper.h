...
/// are valid.
///@{
#define EFI_CACHE_ERROR_TRANSACTION_TYPE_VALID          BIT0
#define EFI_CACHE_ERROR_OPERATION_VALID                 BIT1
#define EFI_CACHE_ERROR_LEVEL_VALID                     BIT2
#define EFI_CACHE_ERROR_PROCESSOR_CONTEXT_CORRUPT_VALID BIT3
#define EFI_CACHE_ERROR_CORRECTED_VALID                 BIT4
#define EFI_CACHE_ERROR_PRECISE_PC_VALID                BIT5
#define EFI_CACHE_ERROR_RESTARTABLE_PC_VALID            BIT6
///@}
...
///
///@{
#define EFI_CACHE_ERROR_TYPE_INSTRUCTION 0
#define EFI_CACHE_ERROR_TYPE_DATA_ACCESS 1
#define EFI_CACHE_ERROR_TYPE_GENERIC     2
///@}

///
/// Type of cache operation that caused the error in ARM Cache Error Structure.
///@{
#define EFI_CACHE_ERROR_OPERATION_GENERIC_ERROR     0
#define EFI_CACHE_ERROR_OPERATION_GENERIC_READ      1
#define EFI_CACHE_ERROR_OPERATION_GENERIC_WRITE     2
#define EFI_CACHE_ERROR_OPERATION_DATA_READ         3
#define EFI_CACHE_ERROR_OPERATION_DATA_WRITE        4
#define EFI_CACHE_ERROR_OPERATION_INSTRUCTION_FETCH 5
#define EFI_CACHE_ERROR_OPERATION_PREFETCH          6
#define EFI_CACHE_ERROR_OPERATION_EVICTION          7
#define EFI_CACHE_ERROR_OPERATION_SNOOPING          8
#define EFI_CACHE_ERROR_OPERATION_SNOOPED           9
#define EFI_CACHE_ERROR_OPERATION_MANAGEMENT        10
///@}
...
/// are valid.
///@{
#define EFI_TLB_ERROR_TRANSACTION_TYPE_VALID          BIT0
#define EFI_TLB_ERROR_OPERATION_VALID                 BIT1
#define EFI_TLB_ERROR_LEVEL_VALID                     BIT2
#define EFI_TLB_ERROR_PROCESSOR_CONTEXT_CORRUPT_VALID BIT3
#define EFI_TLB_ERROR_CORRECTED_VALID                 BIT4
#define EFI_TLB_ERROR_PRECISE_PC_VALID                BIT5
#define EFI_TLB_ERROR_RESTARTABLE_PC_VALID            BIT6
///@}
...
///
///@{
#define EFI_TLB_ERROR_TYPE_INSTRUCTION 0
#define EFI_TLB_ERROR_TYPE_DATA_ACCESS 1
#define EFI_TLB_ERROR_TYPE_GENERIC     2
///@}

///
/// Type of TLB operation that caused the error in ARM TLB Error Structure.
///@{
#define EFI_TLB_ERROR_OPERATION_GENERIC_ERROR                 0
#define EFI_TLB_ERROR_OPERATION_GENERIC_READ                  1
#define EFI_TLB_ERROR_OPERATION_GENERIC_WRITE                 2
#define EFI_TLB_ERROR_OPERATION_DATA_READ                     3
#define EFI_TLB_ERROR_OPERATION_DATA_WRITE                    4
#define EFI_TLB_ERROR_OPERATION_INSTRUCTION_FETCH             5
#define EFI_TLB_ERROR_OPERATION_PREFETCH                      6
#define EFI_TLB_ERROR_OPERATION_LOCAL_MANAGEMENT_OPERATION    7
#define EFI_TLB_ERROR_OPERATION_EXTERNAL_MANAGEMENT_OPERATION 8
///@}
...
/// are valid.
///@{
#define EFI_BUS_ERROR_TRANSACTION_TYPE_VALID   BIT0
#define EFI_BUS_ERROR_OPERATION_VALID          BIT1
#define EFI_BUS_ERROR_LEVEL_VALID              BIT2
#define EFI_BUS_ERROR_CONTEXT_CORRUPT_VALID    BIT3
#define EFI_BUS_ERROR_CORRECTED_VALID          BIT4
#define EFI_BUS_ERROR_PRECISE_PC_VALID         BIT5
#define EFI_BUS_ERROR_RESTARTABLE_PC_VALID     BIT6
#define EFI_BUS_CHECK_PARTICIPATION_TYPE_VALID BIT7
#define EFI_BUS_CHECK_TIME_OUT_VALID           BIT8
#define EFI_BUS_CHECK_ADDRESS_SPACE_VALID      BIT9
#define EFI_BUS_MEMORY_ATTRIBUTE_VALID         BIT10
#define EFI_BUS_ACCESS_MODE_VALID              BIT11
///@}

///
/// Type of bus error in the ARM Bus Error structure
///@{
#define EFI_BUS_ERROR_ERROR_TYPE_INSTRUCTION 0
#define EFI_BUS_ERROR_ERROR_TYPE_DATA_ACCESS 1
#define EFI_BUS_ERROR_ERROR_TYPE_GENERIC     2
///@}
...
///@{
#define EFI_BUS_ERROR_OPERATION_GENERIC_ERROR     0
#define EFI_BUS_ERROR_OPERATION_GENERIC_READ      1
#define EFI_BUS_ERROR_OPERATION_GENERIC_WRITE     2
#define EFI_BUS_ERROR_OPERATION_DATA_READ         3
#define EFI_BUS_ERROR_OPERATION_DATA_WRITE        4
#define EFI_BUS_ERROR_OPERATION_INSTRUCTION_FETCH 5
#define EFI_BUS_ERROR_OPERATION_PREFETCH          6
///@}

///
/// Type of Participation
///@{
#define EFI_BUS_ERROR_PARTICIPATION_TYPE_REQUEST   0
#define EFI_BUS_ERROR_PARTICIPATION_TYPE_RESPONDED 1
#define EFI_BUS_ERROR_PARTICIPATION_TYPE_OBSERVED  2
#define EFI_BUS_ERROR_PARTICIPATION_TYPE_GENERIC   3
///@}

///
/// Type of Address Space
///@{
#define EFI_BUS_CHECK_ADDRESS_SPACE_TYPE_EXTERNAL_MEMORY 0
#define EFI_BUS_CHECK_ADDRESS_SPACE_TYPE_INTERNAL_MEMORY 1
#define EFI_BUS_CHECK_ADDRESS_SPACE_TYPE_DEVICE_MEMORY   3
///@}
...
///@{
#define EFI_ARM_PROC_ERROR_TYPE_CACHE      0x00
#define EFI_ARM_PROC_ERROR_TYPE_TLB        0x01
#define EFI_ARM_PROC_ERROR_TYPE_BUS        0x02
#define EFI_ARM_PROC_ERROR_TYPE_MICRO_ARCH 0x03

///
/// The flags to define the error atrributes in ARM Processor Error Information
/// Structure.
///@{
#define EFI_ARM_PROC_ERROR_INFO_FIRST_ERROR_CAPTURED_FLAG BIT0
#define EFI_ARM_PROC_ERROR_INFO_LAST_ERROR_CAPTURED_FLAG  BIT1
#define EFI_ARM_PROC_ERROR_INFO_PROPAGATED_FLAG           BIT2
#define EFI_ARM_PROC_ERROR_INFO_OVERFLOW_FLAG             BIT3
///@}
...
///@{
#define EFI_REG_CONTEXT_TYPE_0 0
#define EFI_REG_CONTEXT_TYPE_1 1
#define EFI_REG_CONTEXT_TYPE_2 2
#define EFI_REG_CONTEXT_TYPE_3 3
#define EFI_REG_CONTEXT_TYPE_4 4
#define EFI_REG_CONTEXT_TYPE_5 5
#define EFI_REG_CONTEXT_TYPE_6 6
#define EFI_REG_CONTEXT_TYPE_7 7
#define EFI_REG_CONTEXT_TYPE_8 8
///@}
