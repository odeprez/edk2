...
// Refer Table 18.14 in ACPI Specification, Version 6.4.
//
#define EFI_ACPI_6_4_HARDWARE_ERROR_NOTIFICATION_STRUCTURE_INIT(Type,         \
  PollInterval, EventId)                                                      \
  {                                                                           \
    Type,                                                                     \
    sizeof (EFI_ACPI_6_4_HARDWARE_ERROR_NOTIFICATION_STRUCTURE),              \
